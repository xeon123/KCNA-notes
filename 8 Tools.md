...
| Container Runtime and Execution               | runc            | CLI tool for running containers.                                                                        | Follows OCI specification.                                                      |
...
| Storage Solutions                             | Ceph            | Distributed storage system for Kubernetes.                                                              | High performance, reliability, scalability.                                     |
